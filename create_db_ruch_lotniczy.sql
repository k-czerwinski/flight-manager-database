...
ALTER TABLE "samolot" ADD CONSTRAINT NUMER_SAMOLOTU_DLUGOSX CHECK ( length(numer) = 6 );

ALTER TABLE "lotnisko" ADD CONSTRAINT MIASTO_MIN_DLUGOSC CHECK ( length(miasto) >= 3 );

ALTER TABLE "lotnisko" ADD CONSTRAINT NAZWA_MIN_DLUGOSC CHECK ( length(miasto) >= 5 );
